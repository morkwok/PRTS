...
dir_base = 'E:/pythonproject/project002-2/Fig4/'

###汇总Visium HD基因表达数据
# Load Visium HD data 加载Visium HD数据
raw_h5_file = dir_base+'Fig4跑图BA1.h5ad'
...
marker_genes_dict = {
    'Neu': ['Hap1', 'Cacna2d2','Zic1','Grin1','Snph','Calb2','Gpx3','Ncdn','Cacna1h','Kcnma1','Kcnd2','Gria3','Cacna2d1','Camk2n1','Ttc3' ,'Syn3','Itm2b','Stt3b','Ly6h','Sv2c' ],
    'OLG': ['Plp1','Cnp','Mag','Opalin','Mal','Mobp'],
    'AC': ['Apoe','Sparc','Vim','Gja1','Rbp1'],
    'CPEC': ['Ttr','Ecrg4'],
    'VLM': ['Ptgds','Mgp']
}
...
custom_order = ['Neu_01','Neu_02','Neu_03','Neu_04','Neu_05','Neu_06','Neu_07','Neu_08','Neu_09','Neu_10','AC_01','AC_02',
                'AC_03', 'OLG_01', 'OLG_02', 'OLG_03', 'GAC', 'VLM', 'CPEC']  # 按需替换为实际亚群名称
...
plot_annotated_umap(
    ...
    save_path='E:/SCI/002/picture/Fig4/F4i.png'
)
...
plot_clusters_and_save_image(title="Region of interest 1", gdf=gdf, img=img, adata=mydata, color_by_obs='major_celltype', output_name=dir_base+"F4h.tiff")



plot_clusters_and_save_image(title="Region of interest 1", gdf=gdf, img=img, adata=mydata, bbox=(15000,11000,25000,16000), color_by_obs='major_celltype', output_name=dir_base+"F4k-1.tiff")
plot_clusters_and_save_image(title="Region of interest 2", gdf=gdf, img=img, adata=mydata, bbox=(18500,25000,21000,27000), color_by_obs='major_celltype', output_name=dir_base+"F4k-2.tiff")
plot_clusters_and_save_image(title="Region of interest 3", gdf=gdf, img=img, adata=mydata, bbox=(13000,15000,17000,18000), color_by_obs='major_celltype', output_name=dir_base+"F4k-3.tiff")
...
cluster4annotation = {
    ...
    '8': 'neuron',
    '9': 'Astrocyte',
    '10': 'Choroid plexis epithelial cell',
    '11': 'Astrocyte',
    '12': 'Oligodendrocyte',
    '13': 'neuron',
    '14': 'neuron',
    '15': 'vascular and leptomeningeal cell',
    '16': 'glutamatergic astrocyte',
    '17': 'Astrocyte',
    '18': 'Oligodendrocyte'
}
...
celltype_colors = {
    ...
    'Astrocyte': '#99FF99',
    'glutamatergic astrocyte': '#FFCC00',
    'vascular and leptomeningeal cell': '#FF6666',
    'Choroid plexis epithelial cell': '#CC66FF'
}
# 预定义标签顺序（与颜色字典键名对应）
fixed_order = ['neuron', 'Oligodendrocyte', 'Astrocyte', 'glutamatergic astrocyte', 'vascular and leptomeningeal cell','Choroid plexis epithelial cell']  # :ml-citation{ref="5" data="citationList"}
...
plt.axis('equal')
plt.savefig(dir_base + 'F4l-BA1.png', dpi=300, bbox_inches='tight', transparent=True)
plt.show()
