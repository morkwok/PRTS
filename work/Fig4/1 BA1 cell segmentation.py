...
# Create Plot 创建图
plot_mask_and_save_image(title="Complete histological image",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"image_ALL-mask.ROI2.tif")

plot_mask_and_save_image(title="Region of Interest 1",gdf=gdf,bbox=(12844,15136,13760,16333),cmap=cmap,img=img,output_name=dir_base+"image_1-mask.ROI1.tif")

plot_mask_and_save_image(title="Region of Interest 1",gdf=gdf,bbox=(20844,15136,21760,16333),cmap=cmap,img=img,output_name=dir_base+"image_2-mask.ROI1.tif")

gdf.to_csv("area-BA1.csv")
gdf.to_file("area-BA1.shp")
