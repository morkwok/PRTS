...
all_groups_results.to_csv(dir_base+'Frozen-prediction-differential_expression_all_groups.csv', index=False)

count_area_filtered_adata.write('Fig3 run（prediction）.h5ad', compression="gzip")