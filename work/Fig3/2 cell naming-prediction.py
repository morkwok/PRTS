...
raw_h5_file = dir_base+'Fig3 run（prediction）.h5ad'
...
#Fig3b
marker_genes_dict = {
    'Neu': ['Lrp1b', 'Pitpnm2','Stip1','Pitpnm1','Cacnb3','Col25a1' ,'Ncdn','Lrrtm4','Bhlhe22' ,'Slc6a11','Cbln1','Cbln4','Ppp3ca','Slc7a14','C1ql2','Shisal1','Satb2','Slc6a20a','Ppp1r9a','Ndrg4','Snrpn','Atp6v0a1','Orai2','Sema5a' ,'Prox1'],#神经细胞
    'OLG': ['Cd81','Efnb3','Sirt2','Sox10','Myrf','Mog','Mobp'],#少突胶质细胞
    'AC': ['Sparc','Vim'],#星形胶质细胞
    'VLM': ['Ptgds','Igf2','Fn1','Mgp'],
    'CPEC': ['Ttr','Ecrg4']# 脑膜细胞
}
...
custom_order = ['Neu_01','Neu_02','Neu_03','Neu_04','Neu_05','Neu_06','Neu_07','Neu_08','Neu_09','Neu_10','Neu_11','Neu_12',
                'Neu_13', 'Neu_14', 'AC_01', 'AC_02', 'OLG_01', 'OLG_02', 'OLG_03', 'GAC', 'VLM','CPEC']  # 按需替换为实际亚群名称
...
plot_annotated_umap(
    ...
    save_path='E:/SCI/002/picture/Fig3/F3a.png'
)
...
all_groups_results.to_csv(dir_base+'Frozen-prediction-GO(S-table2).csv', index=False)
...
plot_clusters_and_save_image(title="Complete histological image-prediction", gdf=gdf, img=img, adata=mydata, color_by_obs='major_celltype', output_name=dir_base+"F3c.tiff")


plot_clusters_and_save_image(title="cortex-prediction", gdf=gdf, img=img, adata=mydata, bbox=(800,6000,7000,14000), color_by_obs='major_celltype', output_name=dir_base+"F3f.tiff")
plot_clusters_and_save_image(title="Hippocampus and lateral ventricles", gdf=gdf, img=img, adata=mydata, bbox=(5000,7000,12000,14000), color_by_obs='major_celltype', output_name=dir_base+"F3g.tiff")
plot_clusters_and_save_image(title="Hippocampus", gdf=gdf, img=img, adata=mydata, bbox=(4000,8500,11000,20000), color_by_obs='major_celltype', output_name=dir_base+"F3h.tiff")
...
plt.tight_layout()
plt.savefig(dir_base+'F3i-prediction.png', dpi=300, bbox_inches='tight')
plt.close()
# ===========条形图结束============
...
cluster4annotation = {
    ...
    '7': 'neuron',
    '8': 'Astrocyte',
    '9': 'Choroid plexis epithelial cell',
    '10': 'Oligodendrocyte',
    '11': 'glutamatergic astrocyte',
    '12': 'neuron',
    '13': 'neuron',
    '14': 'neuron',
    '15': 'neuron',
    '16': 'vascular and leptomeningeal cell',
    '17': 'neuron',
    '18': 'neuron',
    '19': 'neuron',
    '20': 'neuron',
...
celltype_colors = {
    ...
    'Choroid plexis epithelial cell': '#d4e157',
}

# 预定义标签顺序（与颜色字典键名对应）
fixed_order = ['neuron', 'Oligodendrocyte', 'Astrocyte', 'Choroid plexis epithelial cell','glutamatergic astrocyte','vascular and leptomeningeal cell']  # :ml-citation{ref="5" data="citationList"}
...
plt.title('Proportion of Cell Subpopulations (Predicted)',
          pad=43,
          fontsize=15,
          fontweight='bold',
          color='#000000')
...
plt.axis('equal')
plt.savefig(dir_base + 'F3j-pre.png', dpi=300, bbox_inches='tight', transparent=True)
plt.show()