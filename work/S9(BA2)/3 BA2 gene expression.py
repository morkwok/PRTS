...
#神经元
#'''''''''
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Kcnma1', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S9e-1.pre.tiff")

#少突胶质
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Plp1', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S9e-2.pre.tiff")

#星形胶质
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Ptgds', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S9e-3.pre.tiff")

#脉络丛上皮细胞
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Ttr', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S9e-4.pre.tiff")

#多细胞marker且重要
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Apoe', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S9e-5.pre.tiff")
