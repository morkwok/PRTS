...
plot_mask_and_save_image(title="Region of Interest 1",gdf=gdf,bbox=(6844,9136,9760,10333),cmap=cmap,img=img,output_name=dir_base+"image_1-mask.ROI1.tif")

plot_mask_and_save_image(title="Region of Interest 2",gdf=gdf,bbox=(16844,10136,17760,12333),cmap=cmap,img=img,output_name=dir_base+"image_2-mask.ROI1.tif")

gdf.to_csv("area-BA2.csv")
gdf.to_file("area-BA2.shp")
