...
# Create Plot 创建图
plot_mask_and_save_image(title="Complete histological image",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"IHC-B.tif")

plot_mask_and_save_image(title="Region of Interest 1",gdf=gdf,bbox=(12844,15136,13760,16333),cmap=cmap,img=img,output_name=dir_base+"IHC-B-1.tif")

plot_mask_and_save_image(title="Region of Interest 2",gdf=gdf,bbox=(6800,15136,8000,16333),cmap=cmap,img=img,output_name=dir_base+"IHC-B-2.tif")

gdf.to_csv("area-IHCB1.csv")
gdf.to_file("area-IHCB1.shp")
