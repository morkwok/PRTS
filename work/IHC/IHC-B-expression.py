...
dir_base = 'E:/SCI/002/data/IHC/CUT/B/'
#图像的文件名
filename = '脑公-3 1-1 B.tif'
img = imread(dir_base + filename)

#细胞坐标信息

import geopandas as gpd
gdf = gpd.read_file("E:/pythonproject/project002-2/IHC/area-IHCB1.shp")
...
raw_h5_file = 'E:/SCI/002/data/prediction/IHCB1-prediction.h5ad'
...
#Apoe基因总表达情况
plot_all_area_gene_overlay(title="Complete histological image",gdf=gdf, gene='Apoe', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S4-B-Apoe.tiff")

#Ptgds基因总表达情况
plot_all_area_gene_overlay(title="Complete histological image",gdf=gdf, gene='Ptgds', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S4-B-Ptgds.tiff")

#总HE图
plot_picture(title="Complete histological image",gdf=gdf, gene="Apoe",img=img,adata=count_area_filtered_adata,output_name=dir_base+"S4-B-HE.tiff")




#HE-B-VL-I
plot_picture(title="HE",gdf=gdf, gene="Apoe",img=img,adata=count_area_filtered_adata,bbox=[9000,6000,15000,12000],output_name=dir_base+"Fig2I-VL-HE.tiff")

#Apoe-B-VL-I
plot_gene_overlay(title="Apoe-prediction", gdf=gdf,bbox=(9000,6000,15000,12000), gene='Apoe', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2I-VL-Apoe-gene.tiff")

#Ptgds-B-VL-I
plot_gene_overlay(title="Ptgds-prediction", gdf=gdf,bbox=(9000,6000,15000,12000), gene='Ptgds', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2I-VL-Ptgds-gene.tiff")



#HE-B-AMY-J
plot_picture(title="HE",gdf=gdf, gene="Apoe",img=img,adata=count_area_filtered_adata,bbox=[9000,15000,15000,21000],output_name=dir_base+"Fig2J-AMY-HE.tiff")

#Apoe-B-AMY-J
plot_gene_overlay(title="Apoe-prediction", gdf=gdf,bbox=(9000,15000,15000,21000), gene='Apoe', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2J-AMY-Apoe-gene.tiff")

#Ptgds-B-AMY-J
plot_gene_overlay(title="Ptgds-prediction", gdf=gdf,bbox=(9000,15000,15000,21000), gene='Ptgds', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2J-AMY-Ptgds-gene.tiff")
