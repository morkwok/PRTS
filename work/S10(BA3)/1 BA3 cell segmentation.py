...
# Create Plot 创建图
#plot_mask_and_save_image(title="Region of Interest 1",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"image_mask.ROI1.tif")

#plot_mask_and_save_image(title="Region of Interest 2",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"image_mask.ROI2.tif")

plot_mask_and_save_image(title="TRY-Region of Interest 2",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"BA3image_ALL-mask.ROI2.tif")

plot_mask_and_save_image(title="TRY-Region of Interest 1",gdf=gdf,bbox=(8844,9136,9760,10333),cmap=cmap,img=img,output_name=dir_base+"BA3image_1-mask.ROI1.tif")

plot_mask_and_save_image(title="TRY-Region of Interest 1",gdf=gdf,bbox=(16844,10136,17760,12333),cmap=cmap,img=img,output_name=dir_base+"BA3image_2-mask.ROI1.tif")

gdf.to_csv("area-BA3.csv")
gdf.to_file("area-BA3.shp")
