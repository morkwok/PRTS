...
# Create Plot 创建图
plot_mask_and_save_image(title="Complete histological image",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"S2ab.tif")

plot_mask_and_save_image(title="Region of Interest 1",gdf=gdf,bbox=(12084,17036,13000,18000),cmap=cmap,img=img,output_name=dir_base+"S2c.tif")

plot_mask_and_save_image(title="Region of Interest 2",gdf=gdf,bbox=(6084,6084,7000,7000),cmap=cmap,img=img,output_name=dir_base+"S2d.tif")


gdf.to_csv("area-Frozen.csv")
gdf.to_file("area-Frozen.shp")