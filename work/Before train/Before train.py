...
conda create --name mygo python=3.8
#激活进入conda环境
conda activate mygo
...
# Create Plot 创建图
plot_mask_and_save_image(title="Complete histological image",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"S1ab.tif")

plot_mask_and_save_image(title="Region of Interest 1",gdf=gdf,bbox=(12844,7700,13760,8664),cmap=cmap,img=img,output_name=dir_base+"S1c.tif")

plot_mask_and_save_image(title="Region of Interest 2",gdf=gdf,bbox=(16844,7700,17760,8664),cmap=cmap,img=img,output_name=dir_base+"S1d.tif")


gdf.to_csv("area-input2.csv")
gdf.to_file("area-input2.shp")
