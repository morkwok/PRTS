...
# Create Plot 创建图
#plot_mask_and_save_image(title="TRY-Region of Interest 1",gdf=gdf,bbox=(12084,19036,13000,20000),cmap=cmap,img=img,output_name=dir_base+"003image_1-mask-Frozen.ROI1.tif")

#plot_mask_and_save_image(title="TRY-Region of Interest 2",gdf=gdf,cmap=cmap,img=img,output_name=dir_base+"003image_ALL-mask-Frozen.ROI2.tif")
...
count_area_filtered_adata.write('BrainHD_results-Frozen.h5ad', compression="gzip")
