...
#神经元
#'''''''''
plot_gene_overlay(title="Lateral habenula-prediction", gdf=gdf,bbox=(8000,15000,13000,20000), gene='Kcnma1', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2d.pre.tiff")
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Kcnma1', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S3a.pre.tiff")

#'''''''''


#少突胶质
plot_gene_overlay(title="cortex-prediction", gdf=gdf,bbox=(5000,6000,10000,11000), gene='Plp1', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2e.pre.tiff")
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Plp1', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S3b.pre.tiff")


#星形胶质
plot_gene_overlay(title="Meninges-prediction", gdf=gdf,bbox=(3000,3000,8000,8000), gene='Ptgds', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2f.pre.tiff")
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Ptgds', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S3c.pre.tiff")



#脉络丛上皮细胞
plot_gene_overlay(title="Hippocampus and lateral ventricles-prediction", gdf=gdf,bbox=(6000,8000,11000,13000), gene='Ttr', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2g.pre.tiff")
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Ttr', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S3d.pre.tiff")


#多细胞marker且重要
plot_gene_overlay(title="Hippocampus and lateral ventricles-prediction", gdf=gdf,bbox=(6000,8000,11000,13000), gene='Apoe', img=img, adata=count_area_filtered_adata,output_name=dir_base+"Fig2h.pre.tiff")
plot_all_area_gene_overlay(title="Complete histological image-prediction",gdf=gdf, gene='Apoe', img=img, adata=count_area_filtered_adata,output_name=dir_base+"S3e.pre.tiff")
